...
func runSmartHTTPHookServiceServer(t *testing.T) (*grpc.Server, string) {
	...
	gitalypb.RegisterHookServiceServer(server, hook.NewServer(gitalyhook.NewManager(), hook.GitlabAPIStub, config.Config.Hooks))
...
func TestPostReceiveWithTransactionsViaPraefect(t *testing.T) {
	...
	for _, features := range featureSets {
		t.Run("disabled "+features.String(), func(t *testing.T) {
			...
			gitalypb.RegisterHookServiceServer(gitalyServer.GrpcServer(), hook.NewServer(gitalyhook.NewManager(), hook.GitlabAPIStub, config.Config.Hooks))
...
func TestPostReceiveWithReferenceTransactionHook(t *testing.T) {
	...
	gitalypb.RegisterHookServiceServer(gitalyServer, hook.NewServer(gitalyhook.NewManager(), hook.GitlabAPIStub, config.Config.Hooks))
