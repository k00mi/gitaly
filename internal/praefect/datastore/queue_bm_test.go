...
func BenchmarkPostgresReplicationEventQueue_Acknowledge(b *testing.B) {
	// go test -tags=postgres -test.bench=BenchmarkPostgresReplicationEventQueue_Acknowledge/small -benchtime=1000x gitlab.com/gitlab-org/gitaly/internal/praefect/datastore
	...
	// go test -tags=postgres -test.bench=BenchmarkPostgresReplicationEventQueue_Acknowledge/medium -benchtime=100x gitlab.com/gitlab-org/gitaly/internal/praefect/datastore
	...
	// go test -tags=postgres -test.bench=BenchmarkPostgresReplicationEventQueue_Acknowledge/big -benchtime=10x gitlab.com/gitlab-org/gitaly/internal/praefect/datastore
	...
	// go test -tags=postgres -test.bench=BenchmarkPostgresReplicationEventQueue_Acknowledge/huge -benchtime=1x gitlab.com/gitlab-org/gitaly/internal/praefect/datastore
