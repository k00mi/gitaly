...
// GetCommit2 tries to resolve revision to a Git commit. Returns nil if
// no object is found at revision.
func GetCommit2(ctx context.Context, repo *pb.Repository, revision string) (*pb.GitCommit, error) {
