...
func runInternalGitalyServer(t *testing.T, storages []config.Storage) (*grpc.Server, string) {
	...
	gitalypb.RegisterInternalGitalyServer(grpcServer, NewServer(storages))
